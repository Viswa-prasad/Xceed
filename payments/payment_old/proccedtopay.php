...
<div class="header" >
        ...
        <a href ="..//home page.html"><img src="delete.png" style="float:right; height: 25px; width:30px; padding-right:35px;
      margin-top: 40px; "></a>
</div>
<div class="card">
      <!-- <img src='fail.png' style="height:75px; 
        width:75px;"> -->
...
<tr>
  <div class="button">
    <?php if(!$hash) { ?>
      <td colspan="4"><input  type="submit" value="Confirm to Pay" /></td>
    <?php } ?>
