                        ...
                        <h2 class="form-title"><?php 
                         if ($hash != $posted_hash) {
                              echo "<img src='redcross.png' style='height: 100px; width: 100px; margin-left:250px;'>";
                                    ...
                                    echo "<img src='tick.png' style='height: 100px; width: 100px; margin-left:250px;'>";
                            ...
                            <div class="form-group">
                                ...
                                <p><?php 
                                if ($hash != $posted_hash) {
                                    echo "<h2 style='font-size:40px; font-family:Poppins;'>Invalid Transaction</h2>";
                                      } else {
                                            echo "<h2 style='font-size:40px; font-family:Poppins;'>Transaction Successful</h2>";
                            ...
                            <div class="form-group">
                                ...
                                if ($hash != $posted_hash) {
                                    echo "<h3 style='font-size:20px;'>Please try again</h3>";
                                          ...
                                          echo "<h3 style='font-size:23px;'>Payment received : " . $amount ;
                                      }
